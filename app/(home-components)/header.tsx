...
function HeaderContent() {
  return (
    <div className="bg-darkBG gap-3 flex justify-center items-center flex-col w-full h-[50vh]">
      ...
      <div className="">
        <h1 className=" relative font-extrabold text-transparent text-4xl sm:text-6xl bg-clip-text bg-gradient-to-br from-main to-secondary">
          {" "}
          Mais Conversão
          <Image
            className="absolute sm:bottom-9 sm:-right-4 max-sm:hidden "
            alt="logo"
